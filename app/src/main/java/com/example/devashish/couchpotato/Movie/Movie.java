package com.example.devashish.couchpotato.Movie;
...
/**
 * Created by Devashish on 11/1/2015.
 */
public class Movie {
    public static final String EXTRA_MOVIE = "com.example.devashish.couchpotato.EXTRA_MOVIE";
